...
//            dd($s->teacher()->name);
		...
		//领队
		$sheetLeader = $workbook->addWorkSheet ( gbk ('参赛队') );
		$sheetLeader->writeRow( 0, 0, array_map('gbk', ['序号','学校','地址','领队','领队电话','用餐人数','男队员人数','女队员人数','成人男性人数','成人女性人数']) );
		...
		$n=1;
		foreach ($users as $u) {
			$row = [$n, $u->username, $u->address, $u->leader, $u->tel, $u->diners, $u->boys, $u->girls, $u->adultmales, $u->adultfemales];
